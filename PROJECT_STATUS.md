...
| `feat/dmg-guided-install` | Feature — Guided DMG Install + Homebrew Tap | In Progress | [docs/branches/feat-dmg-guided-install.md](docs/branches/feat-dmg-guided-install.md) |
